Title: Kano SmartWand Async
Date: 2010-12-03 10:20
Category: projects
ProjectStatus: inactive
Authors: Lucas Oskorep
Gitlab: https://gitlab.com/lucasoskorep/kano-wand-python-async
UseReadme: true
Status: hidden

[//]: # (anchor)

# Kano Wand Python Async
...
```
cd existing_repo
git remote add origin https://gitlab.com/lucasoskorep/kano-wand-python-async.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/lucasoskorep/kano-wand-python-async/-/settings/integrations)
